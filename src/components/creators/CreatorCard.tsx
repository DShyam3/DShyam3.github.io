        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0 flex-1">
            {creator.link ? (
              ...
              >
                <span className="truncate block" style={{ textWrap: 'balance' }}>
                  {creator.name}
                  <ExternalLink className="h-3 w-3 inline-block ml-1 align-middle pb-0.5" />
                </span>
              </a>
            ) : (
              <h3 className="text-sm font-medium">
                 <span className="truncate block" style={{ textWrap: 'balance' }}>{creator.name}</span>
              </h3>
            )}
